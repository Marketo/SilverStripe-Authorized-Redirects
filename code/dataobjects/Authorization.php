...
class Authorization extends DataObject
{
    ...
    public static $default_sort = 'Email ASC';
     ...
     * @return int
     */
    public static function AuthorizationErrors(
        AuthorizedPage $Page,
        $Email,
        $AccessCode,
        $ClientKey = null,
        ...
        } elseif (!$Auths->filter('Email', $Email)->count()) {
     ...
     * @return mixed|string
     */
    public static function generateClientKey($use_cookie = true)
    {
        if ($use_cookie) {
    ...
    public static function generateClientInfo()
    {
